...
export const AvatarUploader = () => {
  ...
  const handleUpload = useCallback(async (event: React.ChangeEvent<HTMLInputElement>) => {
    try {
      ...
      if (!file) throw new Error('Você precisa selecionar uma imagem para fazer o upload.');

      if (file.size > 102400) throw new Error('A imagem é muito grande. O tamanho máximo é de 100 KB.');
