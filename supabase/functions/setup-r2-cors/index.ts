...
// Cria a configuração de CORS no formato esperado pelo AWS SDK v3
...
Deno.serve(async (req) => {
  ...
  try {
    // Lê e valida os segredos do ambiente
    ...
    if (!accountId || !accessKeyId || !secretAccessKey || !bucketName) {
      throw new Error("Um ou mais segredos do R2 não estão configurados corretamente no Supabase.");
    }
    ...
    const allowedOrigins = [
      ...
      "https://diypay.com.br",
      "https://*.lovableproject.com" // Domínio de preview da Lovable
    ];
    ...
    // Cria e envia o comando para definir as regras de CORS
